<template>
  <div class="custom-page archives-page">
    <div class="theme-vilivala-wrapper">
      <h1>
        <img
          :src="currentBadge"
...
.archives-page
  .theme-vilivala-wrapper
    @extend $vilivala-wrapper
    position relative
    ...
    .loadmore
      ...
      margin-top 1rem
      opacity 0.5
.theme-mode-dark .archives-page .theme-vilivala-wrapper li a:hover, .theme-mode-read .archives-page .theme-vilivala-wrapper li a:hover
