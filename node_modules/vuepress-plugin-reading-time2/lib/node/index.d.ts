import { LocaleConfig, Plugin, PluginConfig, App } from '@vuepress/core';
...
/** Reading time plugin */
declare const readingTimePlugin: Plugin<ReadingTimeOptions>;
declare const readingTime: (options: ReadingTimeOptions | false) => PluginConfig<ReadingTimeOptions>;
...
export { ReadingTime, ReadingTimeLocaleConfig, ReadingTimeLocaleData, ReadingTimeOptions, ReadingTimePluginPageData, readingTimePlugin as default, getChinese, getReadingTime, getWordNumber, getWords, readingTime, readingTimePlugin, removeReadingTimePlugin, useReadingTimePlugin };
